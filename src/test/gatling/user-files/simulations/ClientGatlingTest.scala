    ...
    val scn = scenario("Test the Client entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                "name":"SAMPLE_TEXT"
                , "salesManagerId":"0"
                , "countryId":"SAMPLE_TEXT"
                , "partnerStatus":null
                , "contactPerson":"SAMPLE_TEXT"
                , "contractEmail":"SAMPLE_TEXT"
                , "industryId":"SAMPLE_TEXT"
                , "signer":"SAMPLE_TEXT"
                , "signerPosition":"SAMPLE_TEXT"
                , "legalAdress":"SAMPLE_TEXT"
                , "registrationNumber":"SAMPLE_TEXT"
                , "baseOfActivityId":"SAMPLE_TEXT"
                , "vatNumber":"SAMPLE_TEXT"
                , "bankName":"SAMPLE_TEXT"
                , "bankAdress":"SAMPLE_TEXT"
                , "swiftCode":"SAMPLE_TEXT"
                , "ibanCode":"SAMPLE_TEXT"
