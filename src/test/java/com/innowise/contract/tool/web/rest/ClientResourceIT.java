...
class ClientResourceIT {
    ...
    private static final LifecycleStatus DEFAULT_LIFECYCLE_STATUS = LifecycleStatus.ACTUAL;
    private static final LifecycleStatus UPDATED_LIFECYCLE_STATUS = LifecycleStatus.DELETED;
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getLifecycleStatus()).isEqualTo(DEFAULT_LIFECYCLE_STATUS);
    }
    ...
    void getAllClients() {
        ...
        webTestClient
            ...
            .value(hasItem(DEFAULT_LIFECYCLE_STATUS.toString()));
    }
    ...
    void getClient() {
        ...
        webTestClient
            ...
            .jsonPath("$.lifecycleStatus")
            .value(is(DEFAULT_LIFECYCLE_STATUS.toString()));
    }
    ...
    void putNewClient() throws Exception {
        ...
        assertThat(testClient.getLifecycleStatus()).isEqualTo(UPDATED_LIFECYCLE_STATUS);
    }
