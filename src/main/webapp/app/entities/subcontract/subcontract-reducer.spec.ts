...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBCONTRACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBCONTRACT actions', async () => {
      const expectedActions = [
        {
