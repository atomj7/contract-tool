...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contract-position.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTPOSITION actions', async () => {
      const expectedActions = [
        {
